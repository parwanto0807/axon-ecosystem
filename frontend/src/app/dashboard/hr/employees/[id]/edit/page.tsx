...
export default function EditEmployeePage() {
    ...
    if (loading) return <div className="p-20 text-center font-black text-slate-400 uppercase tracking-widest">Loading Employee Data...</div>
        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-slate-800 tracking-tight">EDIT KARYAWAN</h1>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Memperbarui Informasi {formData.name}</p>
                    </div>
                </div>
                <button 
                    disabled={saving}
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-20">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100 flex items-center gap-4 opacity-60 grayscale cursor-not-allowed">
                        <div className="w-12 h-12 rounded-xl bg-white text-slate-300 flex items-center justify-center">
                            <ShieldCheck size={24} />
                        </div>
                        <div>
